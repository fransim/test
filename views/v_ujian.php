...
<div class="container">
    ...
    <!--<img class="img-responsive" style="margin:0 auto;" img src="https://i.ibb.co/4fymjjj/tutor.png" alt="tutor">
            <br>1. Panel navigasi soal, jika sudah terjawab maka akan berwarna hijau.*
			<br>2. Tombol untuk lanjut ke pertanyaan berikutnya atau kembali ke pertanyaan sebelumnya.*
			<br>3. Waktu yang disediakan untuk mengisi tes
			<br>4. Jika waktu masih tersisa dan anda ingin menyelesaikan tes, maka bisa menyelesaikan langsung dengan mengklik tombol ini
			<br>
			<br><i>*Jika fungsi tidak ada, maka tes yang anda ikuti tidak mengizinkan untuk kembali ke soal sebelumnya, soal harus diisi terlebih dahulu maka dapat melanjutkan ke soal berikutnya.</i>-->
			<b><h2><br>PETUNJUK PENGERJAAN TES :</h2></b>
			<br> Dalam tes ini terdapat 105 buah pertanyaan. Pertanyaan-pertanyaan dalam tes ini berhubungan dengan perasaan, sikap, atau perilaku Anda.
			<br>
			<br><b>Kerjakanlah berdasarkan respon yang pertama muncul di pikiran Anda dan Anda rasa paling sesuai menggambarkan diri Anda tanpa berpikir terlalu lama karena semua jawaban adalah benar.</b>
			<br>
			<br>Anda diharapkan menghindari jawaban yang bersiat tengah (jawaban B), dan jawablah dengan pilihan A atau C karena akan dapat memberikan gambaran yang lebih jelas mengenai diri Anda. Sekali lagi, Anda diharapkan untuk tidak terlalu lama dalam memilih jawaban.
			<br>
			<br><b><u>Sebagai Contoh :</u></b>
			<br>1. Saya lebih senang menjadi :
			<br>		a. Seorang sarjana teknik perminyakan
			<br>		b. Diantara keduanya
			<br>		c. Seorang penggajar di tingkat Taman Kanak-Kanak
			<br> Dalam soal ini, Anda melingkari pilihan jawaban A, karena pernyataan A merupakan gambaran diri Anda, <i> dimana Anda lebih senang menjadi seorang serjana teknik perminyakan.</i> Tetapi jika pernyataan B atau C yang lebih menggambarkan diri Anda, maka lingkarilah salah satu dari pilihan jawaban tersebut.
	</div>
	</div>
